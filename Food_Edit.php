		...
		<div class = "content">
			...
			<a href = "FoodMenu.php">
				...
				<form method = "post" action = "food_update.php">
					...
					<div class = "InputText">
						<input type = "number" id = "Food_cost" name = "Food_cost" value = "<?PHP echo $COST; ?>" required step = ".1" />
						<label>Cost</label>
					</div>
					...
					<div class = "option" style = "text-align:left;">
								<label>Status</label>
								<br>
								<input class = "checkbox-option" type = "radio" name = "Food_status" id = "Available" value = "Available" required />
