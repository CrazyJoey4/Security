			...
			<h1>Receipt</h1>
				...
				<form method = "post" action = "pay_insert.php" id = "noPrint">
					...
					<div class = "InputText" style = "display:none;">
						...
						<input type = "text" id = "Pay_type" name = "Pay_type" value = "Card" required />
					...
					<div class = "InputText">
						<input type = "number" id = "Card_number" name = "Card_number" required oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength = "16"/>
