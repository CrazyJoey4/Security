<?PHP
	...
	if(isset($_GET['id']))
	{
		...
		$query = "SELECT * FROM table_data WHERE Table_ID = '$ID'";
	...
	<body>
		<div class = "content">
			...
			<button class = "back_btn">
				...
				<form method = "post" action = "table_update.php">
					...
					<div class = "InputText" style = "display:none;">
						<input type = "text" name = "Table_ID" id = "Table_ID"  value = "<?PHP echo $ID; ?>" required />
						<label>ID</label>
					</div>     
