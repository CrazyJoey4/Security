		...
		<div class = "content">
			...
			<span>
				...
				?>
					...
					<th><h1>Category Management</h1></th>
					<button class = 'add_btn' style = "float:right;" onclick = "on()"><i class = 'material-icons'>add</i></button>
					<br><br>
					<?php
						$result = mysqli_query($connected,"select * FROM category_table ORDER BY Category_name ASC");
						...
						while($row = mysqli_fetch_array($result))
						{
							...
							if($row['Category_status'] == "Able")
							{
								echo "<td style = 'background-color:#94FF99'>" . $row['Category_status'] . "</td>";
							}
							else
							{
								echo "<td style = 'background-color:#FF9494'>" . $row['Category_status'] . "</td>";
							}
							
							echo "<td><center><button class = 'edit_btn'><a href = 'Category_Edit.php?id=".$row['ID']."'><i class = 'material-icons'>mode_edit</i></a></button></center></td>";
														
							echo "<td style = 'border-left:hidden;'><center><button class = 'edit_btn'><a href = 'category_delete.php?id=".$row['ID']."' onClick=\"javascript:return confirm('Are you sure you want to delete this?');\"><i class = 'material-icons'>delete</i></a></button></center></td>";
				...
				<div class = "wrap" style = "text-align:center;">
					<form method = "post" action = "category_insert.php">
						...
						<div class = "option" style = "text-align:left;">
								<label>Status</label>
								<br>
								<input class = "checkbox-option" type = "radio" name = "Category_status" id = "Able" value = "Able" required checked />
								<label class = "for-checkbox-option" for = "Able">Able</label>
									
								<input class = "checkbox-option" type = "radio" name = "Category_status" id = "Disable" value = "Disable" required />
