...
if (isset($_GET['id'])) {
	...
	$query = "SELECT * FROM tax_table WHERE Tax_ID = '$ID'";
	...
	<div class="content">
		<div class="wrap">
			...
			<button class="back_btn">
				<a href="Tax.php"><i class='material-icons'>arrow_back</i></a>
			</button>
			<form method="post" action="tax_update.php">
				...
				<div class="InputText" style="display:none;">
					<input type="number" name="Tax_ID" id="Tax_ID" value="<?PHP echo $ID; ?>" required />
					<label>ID</label>
				</div>
				...
				<div class="InputText">
					<input type="text" name="Tax_name" id="Tax_name" value="<?PHP echo $NAME; ?>" required />
					<label>Name</label>
				</div>
				...
				<div class="InputText">
					<input type="number" name="Tax_percent" id="Tax_percent" value="<?PHP echo $tax; ?>" required />
				...
				<div class="option" style="text-align:left;">
					<label>Status</label>
					<br>
					<input class="checkbox-option" type="radio" name="Tax_status" id="Able" value="Able" required />
					<label class="for-checkbox-option" for="Able">Able</label>

					<input class="checkbox-option" type="radio" name="Tax_status" id="Disable" value="Disable"
						required />
