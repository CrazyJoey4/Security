		...
		<div class="wrap">
			...
			<table>
				...
				<tr>
					...
					<th>
						<?PHP echo $symbol . " &nbsp; " . number_format($grossttl, 2, '.', ' '); ?>
					</th>
					<th>
						<?PHP echo $symbol . " &nbsp; " . number_format($taxttl, 2, '.', ' '); ?>
					</th>
					<th>
						<?PHP echo $symbol . " &nbsp; " . number_format($netttl, 2, '.', ' '); ?>
					</th>
					<th>
						<?PHP echo "Card Count : " . $cardcount . "<br>Cash Count : " . $cashcount; ?>
					</th>
					<th colspan="3"></th>
				</tr>
