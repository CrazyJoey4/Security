		...
		<div class = "content">
			...
			<span>
				...
				?>
					...
					<th><h1>Waitlist Management</h1></th>
			...
			<div id = "overlay" class = "overlay">
				<div class = "wrap" style = "text-align:center;">
					<form method = "post" action = "wait_insert.php">
						...
						?>					
							<input type = "text" id = "Wait_ID" name = "Wait_ID" value = "<?PHP echo $value; ?>" required maxlength = "6"/>
							<label>ID</label>
						</div>
						...
						<div class = "InputText">
							<input type = "number" id = "Cus_contact" name = "Cus_contact" required oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);" maxlength = "11" />
